                ...
                Column(
                    ...
                    PrivacySection(
                        ...
                        body = listOf(
                            ...
                            "听歌识曲：仅在您主动使用该功能时持续采集最长 20 秒的环境音频；应用在前台或后台均使用麦克风，并在监听过程中分段上传至自有服务器，与正式曲库的声纹索引进行匹配；录音仅用于当次识别，处理完成后即删除。",
                        ...
                        emphasizeWords = listOf("电子邮箱地址", "密码或密码加密摘要", "IP 地址", "您主动上传的音乐文件、歌词、封面、头像图片", "最长 20 秒的环境音频", "处理完成后即删除", "订单号、支付方式、支付状态", "本地音频文件信息、文件名、音频元数据或文件路径"),
                    )
                    ...
                    PrivacySection(
                        ...
                        body = listOf(
                            ...
                            "麦克风权限：仅在您主动进入听歌识曲并开始识别时，用于录制待识别的短音频；退出页面会停止录音并删除本地临时文件。",
