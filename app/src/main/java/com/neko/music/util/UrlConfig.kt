...
object UrlConfig {
     ...
     * @param musicId 音乐ID
     */
    fun getMusicCoverUrl(musicId: Int): String = "$BASE_URL/api/music/cover/$musicId"
     ...
     * 获取艺术家搜索URL
     */
    fun getArtistSearchUrl(): String = "${BASE_URL}/api/artists/search"

    /**
     * 获取播放列表搜索URL
     */
    fun getPlaylistSearchUrl(): String = "${BASE_URL}/api/playlists/search"

    /**
     * 获取默认用户头像URL
     */
    fun getDefaultAvatarUrl(): String = "${BASE_URL}/api/user/avatar/default"

    /**
     * 获取音乐详情URL
     * @param musicId 音乐ID
     */
    fun getMusicDetailUrl(musicId: Int): String = "${BASE_URL}/detail/$musicId"

    /**
     * 获取歌单详情URL
     * @param playlistId 歌单ID
     */
    fun getPlaylistDetailUrl(playlistId: Int): String = "${BASE_URL}/playlist/$playlistId"
